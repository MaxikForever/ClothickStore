    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("20048768-9e40-4cdc-8762-a822f5fe9d3e"), "623106b4-1fef-48d9-974a-293cfe3aa05b", "Admin", "ADMIN" },
                    { new Guid("b14c9eaf-8d20-4042-abf8-ec3a5af8c093"), "c250c0db-cc00-4e86-a93c-4dcfefc5ccde", "User", "USER" },
                    { new Guid("f05a2392-743b-4025-84fe-1dd1822836e5"), "85610028-213b-4bac-badd-2784cc93133d", "Guest", "GUEST" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Sizes",
                columns: new[] { "Id", "Name" },
                values: new object[] { 71, "59" });

            migrationBuilder.InsertData(
                table: "Sizes",
                columns: new[] { "Id", "Name" },
                values: new object[] { 72, "60" });
